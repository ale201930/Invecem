...
export default function Inspector() {
  ...
  useEffect(() => {
    ...
    // Verificación de rol para botón volver
    ...
    <div className="admin-layout">
      ...
      <aside className={`sidebar ${menuOpen ? "open" : ""}`}>
        ...
        <nav className="nav-menu">
          <li className="nav-item active" onClick={() => router.push("/inspector")}>
            🏠 Inicio
          </li>
          ...
          <li className="nav-item" onClick={() => router.push("/inspector/registro-asistencia")}>
            📝 Registro Asistencia
          </li>

          <li className="nav-item" onClick={() => router.push("/inspector/visitantes")}>
            👤 Visitantes
          </li>
